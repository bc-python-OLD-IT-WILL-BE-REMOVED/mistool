...
     * The module ``parse_use``, and also the associated files ``config/group.py``,` config/pattern.py`` becomes ``and `config/token.py`` becomes ``have been deleted.
